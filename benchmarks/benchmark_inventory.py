...
COVERAGE = [
    ...
    Coverage("PCA", "RobustScatterPCA", "comparative", "benchmarks/latent_structure_benchmarks.py", "subspace error / row AUROC"),
    ...
    Coverage("anomaly detection", "RobustOutlierEnsemble", "comparative", "benchmarks/anomaly_detection_baselines.py", "F1 / ROC AUC"),
    ...
    Coverage("selection", "RobustScatterSelector", "comparative", "benchmarks/auto_scatter_small_sample.py", "selection score / covariance error"),
